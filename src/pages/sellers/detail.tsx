            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                <div className="flex items-center gap-4">
                    <button
                        ...
                        className="p-2.5 bg-white border border-slate-200 rounded-xl text-slate-500 hover:text-slate-900 hover:bg-slate-50 transition-all shadow-sm active:scale-95"
                    >
                    ...
                    <div className="text-left">
                        <h1 className="text-3xl font-bold text-slate-900 tracking-tight flex items-center gap-3">
                            {seller.shopName}
                            {seller.status === 'official' && <div className="p-1 bg-indigo-600 rounded-full shadow-lg shadow-indigo-600/20"><Award className="w-4 h-4 text-white" /></div>}
                        </h1>
                            ...
                            <table className="w-full">
                                ...
                                <tbody className="divide-y divide-slate-100">
                                    {seller.recentOrders.map((order) => (
                                        <tr key={order.id} className="hover:bg-slate-50 transition-all border-b border-slate-100 last:border-none">
                                            <td className="px-8 py-5 text-sm font-bold text-slate-900">{order.id}</td>
                                            <td className="px-8 py-5 text-sm text-slate-500">{order.customer}</td>
