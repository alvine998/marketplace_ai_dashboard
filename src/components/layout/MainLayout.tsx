...
const MainLayout: React.FC = () => {
    ...
    return (
        <div className="min-h-screen bg-[#0f172a] text-slate-200 font-sans flex">
            {/* Sidebar */}
            <aside
                className={`fixed inset-y-0 left-0 z-50 w-72 bg-slate-900 border-r border-slate-800 transition-transform duration-300 ease-in-out ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full'
                                        ...
                                        <div className="pl-4 space-y-1 mt-1 animate-in slide-in-from-top-2 duration-200">
                                            {item.subItems?.map((sub) => {
                                                ...
                                                return (
                                                    ...
                                                    >
                                                        <sub.icon className={`w-4 h-4 ${isSubActive ? 'text-blue-500' : 'text-slate-600'}`} />
            ...
            <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
                ...
                <header className="h-16 bg-slate-900/50 backdrop-blur-md border-b border-slate-800 flex items-center justify-between px-4 lg:px-8 sticky top-0 z-40">
                    ...
                    <div className="flex items-center gap-4">
                        <Link to="/main/notifications" className="relative p-2 rounded-lg hover:bg-slate-800 text-slate-400 transition-colors">
                        ...
                        <div className="flex items-center gap-3 pl-4 border-l border-slate-800">
                            ...
                            <button
                                ...
                                className="ml-2 p-2 rounded-lg text-slate-400 hover:text-red-500 hover:bg-red-500/10 transition-all"
                                title="Logout"
                            >
